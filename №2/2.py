print('Инструкция: 1-й ход делает Игрок_1, который играет "X". Затем право хода переходит Игроку_2, который играет "О"')
print('Игроки ходят поочередно, выбирая свободную клетку поля, которая соответсвует числам от 1 до 9')
list1 = ['1','2', '3']
list2 = ['4','5', '6']
list3 = ['7','8', '9']
print(list1)
